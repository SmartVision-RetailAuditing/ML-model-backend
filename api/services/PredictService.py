...
class PredictService:
    # HATA 3 DÜZELTİLDİ: large_product_embeddings yerine base_product_embeddings yapıldı!
    def __init__(self, catalog_path="product_catalog_sut.json", db_path="weights/dinov2_base_product_embeddings.pkl"):
        ...
        # (N, 768) boyutundaki matrisi tensöre çevirip ekran kartına alıyoruz
    ...
    def process_image(self, img):
        ...
        for prod in raw_products:
            ...
            # HATA 2 DÜZELTİLDİ: preprocess yerine dino_preprocess yapıldı!
            crop_tensor = ai_models.dino_preprocess(crop)
